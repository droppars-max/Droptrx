...
CHANNEL_ID = os.environ.get("CHANNEL_ID", "")  # میتواند @channelusername یا عددی باشد
...
ADMINS_ENV = os.environ.get("ADMINS", "")  # comma separated ids
...
# ---------- ادامه‌ی کد برداشت، کیف پول، تایید و منو ----------
# (همان کد قبلی بدون تغییر، فقط بدون وبهوک)
